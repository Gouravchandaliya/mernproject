      ...
      <nav className="bg-gradient-to-r from-blue-50 to-blue-100 shadow-lg sticky top-0 z-50">
        <div className="flex items-center justify-between px-6 py-4">
          <Link to="/admin/dashboard" className="flex items-center gap-3 hover:opacity-80 transition-opacity">
            ...
            <h1 className="text-2xl font-bold text-blue-900">Restaurant</h1>
          ...
          <div className="flex items-center gap-3">
            <Link 
              ...
              className={`px-6 py-2 rounded-full font-semibold transition-all duration-300 ${
                isActive('dashboard')
                  ...
                  : 'bg-white text-blue-900 hover:bg-blue-800 hover:text-white shadow-md'
              }`}
            >
              Dashboard
            </Link>
            ...
            {/* User Info & Logout */}
            <div className="ml-4 border-l-2 border-blue-300 pl-4 flex items-center gap-3">
              ...
              <button
                ...
                className="px-4 py-2 text-sm rounded-full bg-white text-blue-900 hover:bg-red-600 hover:text-white shadow-md transition-all duration-300"
              >
                Logout
              </button>
            </div>
