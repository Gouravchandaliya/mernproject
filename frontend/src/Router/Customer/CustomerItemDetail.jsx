    ...
    <div className="p-6">
      <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-lg overflow-hidden">
        <div className="lg:flex">
          <div className="lg:w-1/2 h-72 bg-blue-100 flex items-center justify-center">
            {item.imageUrl ? (
          ...
          <div className="lg:w-1/2 p-6">
            ...
            <p className="text-3xl font-bold text-blue-800 mb-6">₹{item.price}</p>
            ...
            <div className="flex gap-3">
              <button onClick={handleAddToCart} disabled={!item.availability} className={`px-6 py-3 rounded-lg font-semibold ${item.availability ? 'bg-blue-800 text-white hover:bg-blue-900' : 'bg-gray-200 text-gray-500'}`}>
                Add to Cart
              </button>
