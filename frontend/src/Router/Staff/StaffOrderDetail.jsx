...
const StaffOrderDetail = () => {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="bg-red-50 border border-red-200 text-red-700 px-4 py-3 rounded-lg">
          ...
          <button onClick={() => navigate(-1)} className="mt-2 px-4 py-2 bg-blue-800 text-white rounded">Go Back</button>
        </div>
      </div>
    )
  }
  ...
  return (
    <div className="p-6 min-h-screen bg-gradient-to-br from-blue-50 via-blue-50 to-blue-50">
